        ...
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                        <li><a href="newadminhome.php" class="active">Home</a></li>
        ...
        <div class="page-content">
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
             ...
             <table id="myTable" class="table table-sm table-bordered border-dark">
              <thead>
              <tr>
                 <th>Vehicle ID</th>
                <th>Plate Number</th>
            ...
            <div class="col-lg-12">
                <div class="main-button">
                  <a href="adminduty.php">Manage Duty</a>
                </div>
              </div>
          </div>
