    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="main">
                        ...
                        <a href="adminvehicle.php" class="active"> <b><i>Vehicle</i></b></a>
...
<br>
              <div class="featured-games header-text">
                <div class="heading-section">
                  <h4><em>Available</em> Vehicles
                   <a href="adminvehicle-add.php" style="width:100%; text-align: center;"><i class=" fas fa-plus-circle">  &nbsp; &nbsp; </i></a></h4>
          ...
          <tbody>
            ...
            while($row = pg_fetch_array($query)) {
              ...
              echo "<td><center>
                        ...
                        <input type='hidden' name='id' value='" . $row['vehicle_id']. "'><input type='submit' name='delete' class='buttonr' value='Delete'>
                        </form></center></td>";
             echo "<td><center>
                        <form action='vehicleupdate.php' method='post'>
                        <input type='hidden' name='id' value='" . $row['vehicle_id']. "'><input type='submit' name='update' class='buttonb' value='Edit'>
                        </form></center></td>";
              echo "</tr>";
            }
            ?>
