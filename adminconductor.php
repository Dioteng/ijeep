    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="main">
                          <a href="adminconductor.php" class="active"> <b><i>Conductor</i></b></a>
  ...
  <br>
                <div class="featured-games header-text">
                  <div class="heading-section">
                    <h4><em>Available</em> Conductors
                    <a href="adminconductor-add.php" style="width:100%; text-align: center;"><i class=" fas fa-plus-circle">  &nbsp; &nbsp;</i></a></h4>
                    <div class="gaming-library">
              <div class="col-lg-12">
                <div class="heading-section">
  <table id="myTable" class="table row-border" style="width:100%;">
            <thead>
              <th style="color: #0d1b2a;">Firstname</th>
              <th style="color: #0d1b2a;">Lastname</th>
              <th style="color: #0d1b2a;">Address</th>
              <th style="color: #0d1b2a;">Email</th>
            ...
            while($row = pg_fetch_array($query)) {
              ...
              echo "<td><center>
                    <form action='conductordelete.php' method='post'><input type='submit' class='buttonr' name='delete' value='Delete'><input type='hidden' name='id' value='" . $row['conductor_id']. "'></form></center></td>";
              echo "<td><center>
                    <form action='conductorupdate.php' method='post'><input type='hidden' name='id' value='" . $row['conductor_id']. "'><input type='submit' name='update' class='buttonb' value='Edit'></form></center></td>";
  echo "</tr>";
            }
            ?>
            </tbody>
