...
if (isset($_POST['update'])) 
  { 
    ...
    $id=$_POST['id'];
    $query="SELECT * FROM conductors WHERE conductor_id='$id'";
    $query_run=pg_query($con,$query);
    $fetch=pg_fetch_array($query_run);
if($query_run)
...
?>
          ...
          <h4><a href="">Update Conductor</a></h4>
              <div id="login">
          <form id="login"  method="post"  enctype="multipart/form-data">
          <div class="form-outline mb-4">
            <input type="text" id="typefname" value="<?php echo $fetch['firstname']; ?>" class="form-control" name="fname" required><label class="form-label text-light" for="typefname">First Name</label>            
          </div>
          <div class="form-outline mb-4">
            <input type="text" id="typelname" value="<?php echo $fetch['lastname']; ?>" class="form-control" name="lname" required><label class="form-label text-light" for="typelname">Last Name</label>            
          </div>
          <div class="form-outline mb-4">
            <input type="text" id="typeemail" value="<?php echo $fetch['email']; ?>" class="form-control" name="email" required><label class="form-label text-light" for="typeemail">Email</label>            
          </div>
          <div class="form-outline mb-4">
            <input type="text" id="address" value="<?php echo $fetch['address']; ?>" class="form-control" name="address" required><label class="form-label text-light" for="address">Address</label>            
          </div>
          <div class="form-outline mb-4">
            <input type="password" id="typefname" value="<?php echo $fetch['password']; ?>" class="form-control" name="password" required><label class="form-label text-light" for="typefname">Password</label>            
          </div>
          <input type="hidden" name="conductor_id" value="<?php echo $fetch['conductor_id']; ?>">   
          <input type="submit" name="update_btn" value="Update Conductor!">
...
if(isset($_POST['update_btn'])) {
    ...
    $sql1 = "CALL up_cond('$conductor_id','$fname','$lname','$email','$address','$password')";

if(pg_query($con,$sql1)) {
    
    echo "<script> alert('Successfully Updated'); window.location='adminconductor.php'; </script>" ;
