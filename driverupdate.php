...
?>
          ...
          <div class="form-outline mb-4">
            <input type="text" id="typelicense" value="<?php echo $fetch['license_no']; ?>" class="form-control" name="license_no" required><label class="form-label text-light" for="typelicense">License No.</label>            
          </div>

          <input type="hidden" name="driver_id" value="<?php echo $fetch['driver_id']; ?>">   
          <input type="submit" name="update_btn" value="Update Driver!"> 
...
if(isset($_POST['update_btn'])) {
    ...
    $sql1 = "CALL up_driv('$driver_id','$fname','$lname','$address','$license')";

if(pg_query($con,$sql1)) {
    
    echo "<script> alert('Successfully Updated'); window.location='admindriver.php'; </script>" ;
