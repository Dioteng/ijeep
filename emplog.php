            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="emplog.php" class="active">Employee Log</a></li>
...
<table id="myTable" class="table row-bordered">
          ...
          <tbody>
            <?php
            $sql = "SELECT CONCAT(d_id, ' ', c_id, ' ',  employee_role) AS emp_role, CONCAT(firstname, ' ', lastname) AS fullname, address, trans_type, trans_user, 
            to_char(trans_date, 'MON-DD-YYYY HH24:MI:SS') AS trans_date
            FROM employee_logs";
